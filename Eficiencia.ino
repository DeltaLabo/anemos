...
* @date 18 May 2021                         Fecha de ultima modificación
...
//Potencia entrada, Potencia de Salida y Eficiencia
...
void loop() {
 ...
 //Corriente RMS Fase 2
  ...
  Vpreviousvalue1 = Vcurrentvalue1; /* Actualización del valor i-1 */
  Ipreviousvalue1 = Icurrentvalue1; /* Actualización del valor i-1 */

  Vpreviousvalue2 = Vcurrentvalue2; /* Actualización del valor i-1 */
  Ipreviousvalue2 = Icurrentvalue2; /* Actualización del valor i-1 */

  Vpreviousvalue3 = Vcurrentvalue3; /* Actualización del valor i-1 */
  Ipreviousvalue3 = Icurrentvalue3; /* Actualización del valor i-1 */
  ...
  if (micros()- ZerointRMS >= PeriodRMS){  /* Calculo de Eficiencia con 1 segundo de mediciones */
    ...
    //Reinicio de las variables acumuladas
    Vsignals1 = 0;
    VsamRMS1 = 0;
    Vsignals2 = 0;
    VsamRMS2 = 0;
    ...
    //Voltaje y Corriente RMS calibrados
    ...
    //Potencia Real [W], Potencia Aparente [VAR] y Factor de Potencia de cada fase
 ...
 */
    ...
    /* The string has the S as firsts character, then 5 spaces for the velocity including two before the dot and two after the dot, the the status of the MTTQ transmission */   
